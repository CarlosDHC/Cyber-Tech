...
function CapitulosDireito() {
  ...
  // CONFIGURAÇÕES ESPECÍFICAS DA ÁREA DE DIREITO
  ...
  const TEXTO_SUBTITULO = "Explore os princípios jurídicos, legislação aplicada e ética no Direito.";
  const TAG_CERTIFICADO = "DIR"; // Tag exata para a página de certificados desbloqueados

  const auth = getAuth(); 

  // 1. BUSCAR A LISTA DE DESAFIOS DA ÁREA DE DIREITO
  useEffect(() => {
        ...
        if (user) {
          try {
            ...
            await setDoc(userRef, {
              certificadosDesbloqueados: arrayUnion(TAG_CERTIFICADO) // Salva a tag "DIR"
            }, { merge: true });
